...
- **Imágenes de producto:** 16 de 20 productos ya tienen foto real (`public/productos/`), confirmadas contra el producto físico. Los 4 restantes usan la ilustración SVG mientras se consiguen — estado y detalle en [`IMAGENES.md`](./IMAGENES.md).
